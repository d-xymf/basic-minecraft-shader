...
#define SHADOW_BRIGHTNESS_NIGHT 0.5 //1.0: no shadows, 0.0: very dark shadows [0.00 0.05 0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45 0.50 0.55 0.60 0.65 0.70 0.75 0.80 0.85 0.90 0.95 1.00]
...
const vec3 blockLightColor = vec3(2.0, 1.4, 1.0);
const vec3 shadowColor = vec3(0.2, 0.3, 0.4);
